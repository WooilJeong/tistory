...
class Tistory:
    ...
    def init_access_token(self, authentication_code):
        ...
        res = requests.get(
            "https://www.tistory.com/oauth/access_token", params=params)
    ...
    def get_access_token(self, authentication_url):
        ...
        if self.driver_path:
            ...
            self.driver = webdriver.Chrome(
                self.driver_path, options=self.options)
        else:
            print("드라이버 경로 미지정")
            self.driver = webdriver.Chrome(
        ...
        self.driver.find_element(
            By.XPATH, """//*[@id="cMain"]/div/div/div/a[1]""").send_keys(Keys.ENTER)
        time.sleep(random.randrange(1, 4))
        self.driver.find_element(
            By.XPATH, """//*[@id="input-loginKey"]""").send_keys(self.kakao_id)
        time.sleep(random.randrange(1, 4))
        self.driver.find_element(
            By.XPATH, """//*[@id="input-password"]""").send_keys(self.kakao_pw)
        time.sleep(random.randrange(1, 4))
        self.driver.find_element(
            By.XPATH, """//*[@id="mainContent"]/div/div/form/div[4]/button[1]""").send_keys(Keys.ENTER)
        time.sleep(random.randrange(1, 4))
        self.driver.find_element(
            By.XPATH, """//*[@id="contents"]/div[4]/button[1]""").send_keys(Keys.ENTER)
        time.sleep(random.randrange(1, 4))
